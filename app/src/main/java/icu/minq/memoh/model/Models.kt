...
@Serializable data class BotSettings(@SerialName("default_bot_agent_id") val defaultBotAgentId: String? = null, @SerialName("chat_runtime") val chatRuntime: String = "model", @SerialName("chat_acp_agent_id") val chatAcpAgentId: String? = null, @SerialName("chat_acp_project_path") val projectPath: String? = null, @SerialName("chat_acp_project_mode") val projectMode: String? = null)
...
@Serializable data class ChatTurn(@SerialName("turn_id") val turnId: String = "", val role: String, val text: String = "", val messages: List<MessageBlock> = emptyList(), val timestamp: String = "", val id: String? = null)
